...
console.log(Type_distance);
var ExploreG_Distance = 'combined_sem_R_n_HM';
// var ExploreG_Distance = 'R_n_HM';
// var ExploreG_Distance = 'oneminussem';
...
var ExploreSP_distance = 'combined_sem_R_r_GM';
// var ExploreSP_distance = 'oneminussem';
console.log('ExploreSP_distance');
console.log(ExploreSP_distance);

// //bug report
// // the var pathG_Distance is linked to the button of " find_path , professional " function
// var PathG_Distance = 'R_n_GM';
// // var PathG_Distance = 'combined_sem_R_n_GM';
// console.log('PathG_Distance')
// console.log(PathG_Distance)
// //bug report
// //the var pathSP_distance is linked to the button of " find_path basic" function
// var PathSP_distance = 'R_r_GM';
// console.log('PathSP_distance');
// console.log(PathSP_distance);

//bug fixing: no change to the var name , but link the right var to the button
var PathG_Distance = 'R_r_HM';
// var PathG_Distance = 'combined_sem_R_r_HM';
//  var PathG_Distance = 'oneminussem';
// var pathG_Ditance actually linked to the specific button, so it's "r"
console.log('PathG_Distance')
console.log(PathG_Distance)
//bug report
//the var pathSP_distance is linked to the button of " find_path basic" function
// var PathSP_distance = 'combined_sem_R_n_GM';
var PathSP_distance = 'R_n_GM';
// var PathSP_distance = 'oneminussem';
// var pathSP_distance actually linked to the general button, so it's 'n'
console.log('PathSP_distance');
console.log(PathSP_distance);
