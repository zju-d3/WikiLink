...
name_list = ['test_new_final','test_new_final_allsem','test_new_final_allstat','test6_37_28_nominus_updated']
myRtr = Retrievor.UndirectedG('zhwebappbeifen/data2021/{0}'.format(name_list[-1]), 'total_v3_csvneo4j', 'userdata')
...
with open('../zhwebappbeifen/data2021/word2id_from_graph.json', encoding='utf8')as fp:
# with open('../zhwebappbeifen/data2021/word2id_directory_new.json', encoding='utf8')as fp:
